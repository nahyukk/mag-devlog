...
#### 🏗️ 기술 아키텍처
<a href="https://drive.google.com/file/d/1QErNSHkt2JozNzCKM1l20NxPVvIM9ETN/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
  <img src="/projects/images/zaro/architecture.png" alt="ZARO ARCHITECTURE" />
</a>
...
<a href="https://drive.google.com/file/d/1SE1fis4qmMyXu2rNRewPT6Gny36EdNar/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
  <img src="/projects/images/zaro/zaro-회원관리이슈.png" alt="ZARO 회원관리이슈" style={{ padding: "15px", justifyItems: "center", width: "60%", maxWidth: "600px" }} />
</a>
**문제 1**  
...
**문제 3**  
- DORMANT 전환 30일 전 메일 안내 시, 로그인 활동으로 `lastLoginAt`이 갱신되더라도 이전 발송 이력을 기준으로 재발송되지 않아 안내 메일 누락이 발생할 수 있었습니다.
...
- 6개월 미 접속 DORMANT 회원 처리
    - 휴면 이전 회원 공지 필요 (법적 이슈)  - 휴면 전환 30일 전 안내 메일 발송 스케줄러 처리
        ...
        <a href="https://drive.google.com/file/d/1bjqzCiqNA3V02vMWD6rzqMWemq_qoltD/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
          <img src="/projects/images/zaro/zaro-휴면회원메일.png" alt="ZARO 휴면회원메일" style={{ padding: "15px", justifyItems: "center", width: "50%", maxWidth: "500px" }} />
        </a>
    ...
    <div style={{ display: "flex", flexDirection: "Column", justifyItems: "center"}}>
      <a href="https://drive.google.com/file/d/1bjqzCiqNA3V02vMWD6rzqMWemq_qoltD/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
        <img src="/projects/images/zaro/zaro-휴면로그인전후.png" alt="ZARO 휴면로그인전후" style={{ padding: "15px", justifyItems: "center", width: "40%", maxWidth: "500px" }} />
      </a>
      <small style={{ color: "var(--sub-text-color)", justifyItems: "center" }}>
        휴면 상태 로그인 전, 후
      </small>
    </div>
...
- 휴면 안내 메일 중복 및 누락 방지
  - 현재 회원의 `lastLoginAt` 기준으로 5개월이 경과시 메일이 발송 되는 스케줄러를 구현
      ...
      <div style={{ display: "flex", flexDirection: "Column", justifyItems: "center"}}>
          <a href="https://drive.google.com/file/d/1dx508WvsX278cJXSPtzZAVZ5mER3RfRw/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
            <img src="/projects/images/zaro/zaro-휴면스케줄러전.png" alt="ZARO 휴면스케줄러전" style={{ padding: "15px", justifyItems: "center", width: "70%", maxWidth: "600px" }} />
          </a>
          <small style={{ color: "var(--sub-text-color)", justifyItems: "center" }}>
            휴면 스케줄러 및 repository query 변경 전, 메일 발송 누락 발생
          </small>
      </div>
  - 휴면 해제 후 `lastLoginAt` 변경, 이후 비로그인 5개월 경과 후 `DormancyNoticeLog`에 메일 전송 이력 존재로 메일 발송이 누락
  ...
  - 매일 스케줄러 실행 시, 현재 회원의 `lastCheckedLoginDate` 기준으로 5개월이 경과하고 해당 기준의 발송 이력이 없을 경우에만 메일 발송
    <div style={{ display: "flex", flexDirection: "Column", justifyItems: "center"}}>
        <a href="https://drive.google.com/file/d/1Gy1tUFJ9SkDCbllg_wg8nN1A7OH0p7cu/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
          <img src="/projects/images/zaro/zaro-휴면스케줄러후.png" alt="ZARO 휴면스케줄러후" style={{ padding: "15px", justifyItems: "center", width: "70%", maxWidth: "600px" }} />
        </a>
        <small style={{ color: "var(--sub-text-color)", justifyItems: "center" }}>
...
- Jenkins 서버 이관 및 팀 기반 운영 환경 구성
  ...
  <div style={{ display: "flex", flexDirection: "Column", justifyItems: "center"}}>
      <a href="https://drive.google.com/file/d/1XyKMqFwhfZ7nfQhjo0HS8jwDUF28pAje/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
        <img src="/projects/images/zaro/zaro-jenkins-서버작업.png" alt="ZARO 젠킨스 서버작업" style={{ padding: "15px", justifyItems: "center", width: "90%" }} />
      </a>
  </div>
  - Jenkinsfile을 GitHub에 버전 관리하여 변경 이력을 공유
  - 사용자 계정을 추가하여 팀원 모두가 빌드 결과 및 상태 확인 가능하도록 설정(Role-Based Authorization Strategy 플러그인)
  <div style={{ display: "flex", flexDirection: "Column", justifyItems: "center"}}>
      <a href="https://drive.google.com/file/d/1-DH7M42Gp9Uw40Q0SjcHvZELDeRvKldv/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
        <img src="/projects/images/zaro/zaro-jenkins-plugin.png" alt="ZARO jenkins-plugin" style={{ padding: "15px", justifyItems: "center", width: "70%", maxWidth: "600px" }} />
      </a>
  </div>
  <div style={{ display: "flex", flexDirection: "Column", justifyItems: "center"}}>
      <a href="https://drive.google.com/file/d/1Tvy_WNEf3t6z9lDyIECblUsXmoXD4j6g/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
        <img src="/projects/images/zaro/zaro-rolebased.png" alt="ZARO rolebased" style={{ padding: "15px", justifyItems: "center", width: "70%", maxWidth: "600px" }} />
      </a>
  </div>
...
- Blue-Green 기반의 Hot Standby 방식의 Main/Sub 서버 무중단 배포 구성
  ...
  <div style={{ display: "flex", flexDirection: "Column", justifyItems: "center"}}>
      <a href="https://drive.google.com/file/d/1A9n8iWeMAMhcc4DlaRWJDuGo76QoADW_/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
        <img src="/projects/images/zaro/zaro-무중단.png" alt="ZARO 무중단" style={{ padding: "15px", justifyItems: "center", width: "90%" }} />
      </a>
  </div>
  ...
  <div style={{ display: "flex", flexDirection: "Column", justifyItems: "center"}}>
      <a href="https://drive.google.com/file/d/1rrKc53Gxkes6W8yETvcvzkVExiblg_-_/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
        <img src="/projects/images/zaro/zaro-무중단에러.png" alt="ZARO 무중단에러" style={{ padding: "15px", justifyItems: "center", width: "50%", maxWidth: "500px" }} />
      </a>
  </div>
  - 배포 스크립트 흐름:
    <div style={{ display: "flex", flexDirection: "Column", justifyItems: "center"}}>
        <a href="https://drive.google.com/file/d/17jrpRwrqOf8yFtlFUq_-e11J8cUFgPjL/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
          <img src="/projects/images/zaro/zaro-젠킨스스크립트.png" alt="ZARO 젠킨스스크립트" style={{ padding: "15px", justifyItems: "center", width: "90%" }} />
        </a>
    </div>
    1. 현재 운영 서버 확인
...
**🔗 배포 관련 다른 트러블슈팅 |** 
- [Jenkins + Docker 기반 배포 자동화 & DooD 구성 트러블슈팅](/blog/troubleshooting-Jenkins-Docker-Based-Deployment-Automation-with-DooD-Setup)
- [Sub 서버 Redis 연결 트러블슈팅](https://github.com/code-is-evenly-cooked/even-zaro-back/issues/139)
- [Jenkins 동시 빌드 문제 해결](https://github.com/code-is-evenly-cooked/even-zaro-back/issues/140)
...
#### 📚 Learning Point
- 인증/인가 시스템의 흐름 정합성과 상태 자동화(휴면/인증 등)의 중요성을 경험
- GlobalExceptionHandler, 커스텀 Validator 도입으로 계층별 책임 분리와 예외 응답의 일관성 확보
- EC2, RDS, S3, Jenkins 등 실 인프라 구성 및 무중단 배포 자동화를 통해 운영 환경에 대한 감각 향상
- 동일 스펙 서버를 역할 분리하여 활용함으로써 클라우드 비용 최적화(76% 절감)의 중요성 체득
- 중복 호출 제거 및 쿼리 최적화를 통한 API 응답 성능 개선 경험
- 프론트엔드 흐름을 고려한 API 설계 및 일부 UI 구현 경험을 통해 풀스택 시야 확보
- 기획–설계–구현–배포까지 End-to-End를 직접 리딩하며 문제 해결력과 기술 문서화 능력 향상

---

**🔗 GitHub |** [even-zaro-back](https://github.com/your-repo-link)     
**🔗 배포 링크 |** [ZARO](https://zaro.vercel.app/) - 25.06.30 인스턴스 종료로 기능 사용 불가
